<div class="article-header"><?php $post = get_post();setup_postdata($post);$sign = get_post_meta(get_the_ID(),'sign',true);
$sign = $sign?'<span class="item post-sign">'.$sign.'</span>':'';?>
	...
	<div class="article-meta">
		...
		<span class="item item-cats"><i class="icon icon-cat"></i> <?php echo MBThemes_categorys();?></span>
