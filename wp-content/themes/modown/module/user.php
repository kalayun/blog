<div class="main"><?php global $current_user;?>
	...
	<div class="container container-user">
	  <div class="userside">
	    ...
	    <div class="usermenus">
	      <ul class="usermenu">
	        <li class="usermenu-user <?php if((isset($_GET['action']) && $_GET['action'] == 'info') || !isset($_GET['action'])) echo 'active';?>"><a href="<?php echo add_query_arg('action','info',get_permalink())?>"><i class="icon icon-info"></i> 我的资料</a></li>
