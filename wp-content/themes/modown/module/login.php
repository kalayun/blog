<div class="sign">			
	...
	<div class="sign-box">			
		...
		<form id="sign-in">  
			...
			<div class="form-item">
				<input type="text" class="form-control" id="user_captcha" name="user_captcha" placeholder="验证码"><img src="<?php bloginfo("template_url");?>/static/img/captcha.png" class="captcha-clk2"/>
			...
			<div class="sign-social">
				...
				<?php if(_MBT('oauth_weixin') || _MBT('oauth_weixin_mobile')){?>
					...
					<a class="login-weixin erphplogin-weixin-loader" data-return="<?php echo MBThemes_selfURL();?>" href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=<?php echo _MBT('oauth_weixinid_mobile');?>&redirect_uri=<?php echo home_url();?>/oauth/weixin/&response_type=code&scope=snsapi_userinfo&state=MBT_weixin_login#wechat_redirect" rel="nofollow"><i class="icon icon-weixin"></i></a>
					<?php }elseif(_MBT('oauth_weixin')){?>
					<a class="login-weixin erphplogin-weixin-loader" data-return="<?php echo MBThemes_selfURL();?>" href="https://open.weixin.qq.com/connect/qrconnect?appid=<?php echo _MBT('oauth_weixinid');?>&redirect_uri=<?php echo home_url();?>/oauth/weixin/&response_type=code&scope=snsapi_login&state=MBT_weixin_login#wechat_redirect" rel="nofollow"><i class="icon icon-weixin"></i></a>
					<?php }?>
				<?php }?>	
				<?php if(_MBT('oauth_weixin_mp') && function_exists('ews_login') && (!modown_is_mobile() || (modown_is_mobile() && !_MBT('oauth_weixin_mobile')))){?><a class="login-weixin signmp-loader" href="javascript:;"><i class="icon icon-weixin"></i></a><?php }?>	
				<?php if(_MBT('oauth_google')){?>
            	<a href="<?php echo wp_login_url();?>?loginSocial=google&redirect=<?php echo MBThemes_selfURL();?>" rel="nofollow" class="login-google"><i class="icon icon-google"></i></a>
            	<?php }?>
            	<?php if(_MBT('oauth_facebook')){?>
            	<a href="<?php echo wp_login_url();?>?loginSocial=facebook&redirect=<?php echo MBThemes_selfURL();?>" rel="nofollow" class="login-facebook"><i class="icon icon-facebook"></i></a>
            	<?php }?>
            	<?php if(_MBT('oauth_twitter')){?>
            	<a href="<?php echo wp_login_url();?>?loginSocial=twitter&redirect=<?php echo MBThemes_selfURL();?>" rel="nofollow" class="login-twitter"><i class="icon icon-twitter"></i></a>
            	<?php }?>	
			</div>	
			<?php }?>	
		...
		<form id="sign-up" style="display: none;"> 	
			...
			<div class="form-item">
				...
				<a href="<?php echo add_query_arg('action','invitation',get_permalink(MBThemes_page('template/login.php')));?>" target="_blank" rel="nofollow" class="invitation-link">购买邀请码</a>
				<?php }elseif(_MBT('invitation_link')){?><a href="<?php echo _MBT('invitation_link');?>" target="_blank" rel="nofollow" class="invitation-link">获取邀请码</a><?php }?>
			</div>
			<?php }?>	
			<div class="sign-submit">			
